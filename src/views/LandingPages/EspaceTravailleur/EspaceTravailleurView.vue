...
import profileInfoCard from "./Sections/ProfileInfoCard.vue";
import DefaultProjectCard from "./Sections/DefaultProjectCard.vue";
import PlaceHolderCard from "./Sections/PlaceHolderCard.vue";
import SoftAvatar from "./Sections/SoftAvatar.vue";
import MaterialTextArea from "./Sections/MaterialTextArea.vue";
    ...
    <div class="mx-4 overflow-hidden card card-body blur shadow-blur mt-n6">
      <div class="row gx-4">
        ...
        <div class="col-auto my-auto">
          <div class="h-100">
            <h5 class="mb-1">Nom et Prenom</h5>
            <p class="mb-0 text-sm font-weight-bold">Post occupé</p>
          </div>
        </div>
        <div
  ...
  <div class="py-4 container-fluid">
    <div class="mt-3 row">
      <div class="col-12 col-md-6 col-xl-4">
        <div class="card h-100">
          <div class="p-3 pb-0 card-header">
            <h6 class="mb-0">Note de frais</h6>
          </div>
          <div class="p-3 card-body">
            <MaterialInput class="input-group-outline" placeholder="Type here..." size="lg" />
            <div class="row">
                      <div class="col-md-12 text-center">
                        <MaterialButton
                          ...
                          color="success"
                          class="mt-3 mb-0"
                          >Envoyer le message</MaterialButton
                        >
                      </div>
                    </div>
          </div>
          <div class="p-3 pb-0 card-header">
            <h6 class="mb-0">Demande absences</h6>
          </div>
          <div class="p-3 card-body">
            <MaterialInput class="input-group-outline" placeholder="Type here..." size="lg" />
            <div class="row">
      ...
      <div class="mt-4 col-12 col-xl-4 mt-xl-0">
        <div class="card h-100">
          <div class="p-3 pb-0 card-header">
            <h6 class="mb-0">Vos fiches de paie</h6>
          </div>
          <div class="p-3 card-body">
            <ul class="list-group">
              <li
